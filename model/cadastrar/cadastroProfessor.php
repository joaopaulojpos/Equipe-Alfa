...
if (isset($_POST['codigoProfessor'])) {
    ...
    if ($codigoProfessor == "" || $codigoProfessor == null) {
        ...
        if ($nome == "" || $nome == null) {
            echo "<script type='text/javascript'>alert('Insira o nome do Professor');location.href='../../view/cadastroProfessor.php';</script>";
        } else {
            if ($codigo == $codigoProfessor) {
                echo "<script type='text/javascript'>alert('Este Professor já encontra-se cadastrado');location.href='../../view/cadastroProfessor.php'</script>";
            } else {
