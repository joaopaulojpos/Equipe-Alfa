...
if (isset($_POST['codigoTipoUsuario'])) {
    ...
    if ($codigoTipoUsuario == "" || $codigoTipoUsuario == null) {
        echo "<script type='text/javascript'>alert('Selecione o tipo do usuário');location.href='../../view/cadastroTipoUsuario.php';</script>";
    } else {
        if ($descricaoTipoUsuario == "" || $descricaoTipoUsuario == null) {
            echo "<script type='text/javascript'>alert('Descreva o tipo de usuário que será cadastrado');location.href='../../view/cadastroTipoUsuario.php';</script>";
        } else {
            if ($codigo == $codigoTipoUsuario) {
                echo "<script type='text/javascript'>alert('Este código já encontra-se cadastrado');location.href='../../view/cadastroTipoUsuario.php'</script>";
            } else {
                ...
                if ($result) {
                    echo "<script type='text/javascript'>alert('Cadastro concluído com sucesso!');location.href='../../view/listarTipoUsuario.php';</script>";
                } else {
                    echo "<script type='text/javascript'>alert('Não foi possível concluir o cadastro');location.href='../../view/cadastrarTipoUsuario.php'</script>";
                }
            }
        }
    }
